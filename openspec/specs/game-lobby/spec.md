...
A player who rejoins a room mid-game SHALL rejoin their seat and receive the full current game-state snapshot. If a disconnected human returns before the grace period expires, the seat SHALL revert to human control and the bot handoff SHALL not occur.
